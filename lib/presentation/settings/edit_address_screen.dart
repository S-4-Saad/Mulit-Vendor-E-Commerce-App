...
class _EditAddressScreenState extends State<EditAddressScreen> {
  ...
  void initState() {
    ...
    selectedAddressType.text = widget.address.title??'';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title: Labels.editAddress),
                  ...
                  onPressed: () async {
                    if (_editAddressKey.currentState!.validate()) {
                      ...
                      try {
                        ...
                        if (success) {
                          SnackBarHelper.showSuccess(context, Labels.addressUpdatedSuccessfully);
                          // Show success message and go back

                          Navigator.pop(context);
                        } else {
                          SnackBarHelper.showError(context, Labels.failedToUpdateAddress);

                        }
                      } catch (e) {
                        // Close loading dialog
                        Navigator.pop(context);
                        SnackBarHelper.showError(context, '${Labels.error} $e');
                        

                      }
                    }
                  },
                  child: Text(Labels.updateAddress, style: TextStyle(
