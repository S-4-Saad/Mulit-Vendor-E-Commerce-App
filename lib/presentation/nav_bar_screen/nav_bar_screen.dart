  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        // Responsive values
        final titleFontSize =
            isLargeTablet ? 24.0 : (isMediumTablet ? 22.0 : 20.0);
        final logoWidth = isLargeTablet ? 130.0 : (isTablet ? 120.0 : 110.0);
        final expandedHeight =
            isTablet ? (isLargeTablet ? 190.0 : 180.0) : 170.0;
        final expandedHeightOther = isTablet ? 140.0 : 120.0;
        final bottomNavIconSize =
            isLargeTablet ? 30.0 : (isTablet ? 28.0 : 27.0);
        final bottomNavUnselectedSize =
            isLargeTablet ? 28.0 : (isTablet ? 26.0 : 24.0);
              ...
              builder: (context, state) {
                ...
                return PopScope(
                  ...
                  onPopInvokedWithResult: (didPop, result) async {
                    ...
                    // If not on home tab (index 2), navigate to home first
                    if (state.currentTab != 2) {
                      bloc.add(SelectTab(2));
                      return;
                    }

                    // If already on home tab, show exit confirmation dialog
                    final shouldPop = await showDialog<bool>(
                      ...
                      builder:
                          (context) => AlertDialog(
                            ...
                            title: Text(Labels.exitSpeezuApp),
                            content: Text(
                              Labels.areYouSureYouWantToExitTheApplication,
                            ),
                            actions: [
                              TextButton(
                                onPressed:
