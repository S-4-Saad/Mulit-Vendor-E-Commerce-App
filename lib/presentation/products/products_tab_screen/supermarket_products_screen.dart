...
class SupermarketProductsScreen extends StatefulWidget {
  SupermarketProductsScreen({super.key});

  @override
  State<SupermarketProductsScreen> createState() => _SupermarketProductsScreenState();
}

class _SupermarketProductsScreenState extends State<SupermarketProductsScreen> {
  @override
  void initState() {
    super.initState();
    print('object');
