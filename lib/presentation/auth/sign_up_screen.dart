...
class _SignUpScreenState extends State<SignUpScreen> {
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          children: [
                            ...
                            _buildSignUpForm(context, maxWidth: double.infinity),
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          Labels.createAnAccountToGetStarted,
                          textAlign: TextAlign.center,
                          style: TextStyle(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          Labels.fillInYourDetailsToRegister,
                          style: TextStyle(
                            fontSize: 14,
                            fontFamily: FontFamily.fontsPoppinsRegular,
    ...
    return Column(
      children: [
        ...
        if (!isMobile) ...[
          const SizedBox(height: 8),
          Text(
            Labels.createYourAccountToGetStarted,
            textAlign: TextAlign.center,
            style: TextStyle(
              color: Theme.of(context).colorScheme.onSurface.withOpacity(0.6),
              fontSize: 14,
  ...
  Widget _buildSignUpForm(BuildContext context, {required double maxWidth}) {
    return Form(
      key: _signUpFormKey,
      child: Column(
